...
/**
* @see \App\Http\Controllers\ServiceTicketController::report
 * @see app/Http/Controllers/ServiceTicketController.php:310
 * @route '/dashboard/tickets/{ticket}/report'
 */
export const report = (args: { ticket: number | { id: number } } | [ticket: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/dashboard/tickets/{ticket}/report'
 */
report.url = (args: { ticket: number | { id: number } } | [ticket: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { ticket: args }
    }
 ...
 * @route '/dashboard/tickets/{ticket}/report'
 */
report.get = (args: { ticket: number | { id: number } } | [ticket: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: report.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/dashboard/tickets/{ticket}/report'
 */
report.head = (args: { ticket: number | { id: number } } | [ticket: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: report.url(args, options),
    method: 'head',
})
 ...
 * @route '/dashboard/tickets/{ticket}/report'
 */
    const reportForm = (args: { ticket: number | { id: number } } | [ticket: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/dashboard/tickets/{ticket}/report'
 */
        reportForm.get = (args: { ticket: number | { id: number } } | [ticket: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: report.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/dashboard/tickets/{ticket}/report'
 */
        reportForm.head = (args: { ticket: number | { id: number } } | [ticket: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
signReception: Object.assign(signReception, signReception),
approveRepair: Object.assign(approveRepair, approveRepair),
completeRepair: Object.assign(completeRepair, completeRepair),
signDelivery: Object.assign(signDelivery, signDelivery),
